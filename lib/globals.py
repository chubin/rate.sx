...
MSG_GITHUB_BUTTON = (
    " " + "\033[100;30m" + "[github.com/chubin/rate.sx]" + Style.RESET_ALL
)
MSG_FOLLOW_ME = (
    "[Follow \033[46m\033[30m@igor_chubin\033[0m for updates]" + Style.RESET_ALL
)
MSG_FOLLOW_ME = (
    Fore.CYAN + "[Follow @igor_chubin for rate.sx updates]" + Style.RESET_ALL
)
...
MSG_NEW_FEATURE = (
    ...
    + _g("curl rate.sx/eth")
    + " (or any other coin instead of ETH)"
)
